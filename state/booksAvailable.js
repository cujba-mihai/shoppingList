...
const booksAvailable = [
  {
    name: 'Production-Ready Microservices', author: 'Susan J. Fowler', price: '$32', imageSrc: '/shoppingList/images/41yJ75gpV-L._SX381_BO1,204,203,200_.jpg', id: idGenerator.next().value, pages: 259, language: 'English', publisher: "O'Reilly Media", publicationDate: 'November 30, 2016', readingAge: 18, rating: 4.8, description: `
    ...
    ` },
  {
    name: 'Release It!', author: 'Michael T. Nygard', price: '$45', imageSrc: '/shoppingList/images/414CRjLjwgL._SX403_BO1,204,203,200_.jpg', id: idGenerator.next().value, pages: 350, language: 'English', publisher: 'Pragmatic Bookshelf', publicationDate: 'July 12, 2017', readingAge: 18, rating: 3.5, description: `
  ...
  ` },
  {
    name: 'React-and-React-Native---Third-Edition', author: 'Adam Boduch , Roy Derks ', price: "$5", imageSrc: '/shoppingList/images/react_and_reactNative.png', id: idGenerator.next().value, pages: 320, language: 'English', publisher: 'Lumina', publicationDate: 'September 4, 2012', readingAge: 18, rating: 2.4, description: `
